...
export const POSTS = [
  {
    ...
    "ua": {
      "cat": "Діабет",
      "title": "Дослідження лікування діабету 1 типу: за якими дослідження варто стежити у 2026 році",
