...
export const POSTS = [
  {
    "slug": "menopause-cost-workplace-productivity",
    "date": "2026-08-18",
    "image": "/images/menopause-cost-workplace-productivity.jpg",
    "cats": [
      "perimenopause"
    ],
    "en": {
      ...
      "excerpt": "A RAND report puts lost productivity from menopause symptoms at $5.4 billion a year in the US — and says that figure deliberately leaves out early retirement, missed promotions and stepping down to a lesser job.",
      "meta": "18 August 2026 · 4 min read",
      "lead": "Around 30% of women in the US labour force are between 45 and 60 — the years most associated with menopause. That is not a niche group, and the cost of leaving their symptoms untreated now has a number attached to it.",
      "blocks": [
        {
          "t": "p",
          "text": "The number comes from a RAND report published in 2025, The Economic Impacts of Menopause in the United States. Its estimate is $5.4 billion a year in lost productivity — missed workdays, reduced hours and layoffs. What makes it worth quoting is not the size of the figure but how it was built: the authors describe it as a conservative lower bound that excludes early retirement, missed promotions and moves to lower-paying jobs. The real cost is above it, not around it."
        },
        {
          "t": "p",
          "text": "Dr Wendy Troxel, a senior behavioural scientist at RAND and one of the report's authors, framed the timing as the point that matters. Menopause lands exactly when women's careers and expertise are peaking. Symptoms that go unsupported stall people at the moment they would otherwise hit their stride — and, as she put it to KBIA, the purpose of the report is not to suggest women are broken by the transition, but that a large and vital part of the workforce should have access to treatments that work."
        },
        {
          "t": "p",
          "text": "The symptoms doing the damage at work are the ordinary ones: broken sleep, hot flushes, brain fog, irritability, low mood. Nothing exotic, which is part of why they get waved through. Dr Lauren Streicher, founder of the Northwestern Medicine Center for Sexual Medicine and Menopause, makes the harder point about what untreated menopause costs beyond productivity — mental health problems, osteoporosis, and increased risk of cardiovascular disease and stroke. Menopause, in her phrase, is not harmless, and it is not just about dressing in layers and carrying a fan."
        },
        {
          "t": "p",
          "text": "The treatment gap has a specific history. In 2003 the FDA added a black box warning to hormone therapy after early Women's Health Initiative data pointed to raised risks of breast cancer, heart attack, stroke and clots. Use collapsed — research from the University of Vermont published in 2012 found HRT use fell by more than 46% within a few years — and by 2023, Mayo Clinic data put use among women aged 40 and over at just 1.7%. The original trial population skewed older than the women who typically start treatment, and reanalysis for women under 60, or within ten years of menopause onset, found the risks dramatically reduced or absent. The FDA announced its intention to withdraw the warning in November 2025 and approved the first prescribing information without it in February 2026."
        },
        {
          "t": "p",
          "text": "The FDA's 2025 press release also cited associations between hormone therapy and a 50% reduction in heart attack risk, a 64% reduction in cognitive decline and a 35% lower risk of Alzheimer's, alongside reduced all-cause mortality and fewer fractures. Those are worth reading carefully rather than repeating flat: they are associations drawn largely from observational data in women who started treatment early, and observational data cannot separate the treatment from the kind of person who gets prescribed it. Symptom relief is the claim with the strongest evidence behind it — and it arrives fast. Dr Lisa Brennaman, an OBGYN at University of Missouri Health Care, said improvement typically shows within about seven days of starting."
        },
        {
          "t": "p",
          "text": "None of which makes hormone therapy right for everyone. Brennaman's own caution is that other causes of the same symptoms should be looked for, and that some forms are a poor fit for anyone with a history of clots, stroke or an oestrogen-sensitive cancer. The point she makes about thresholds is the useful one for a reader: symptoms that occur daily or interfere with functioning deserve a conversation about options — you should not have to reach job loss, a fractured hip or complete exhaustion before asking. If you want the wider picture on how prescribing has changed since the warning came off, I've written about [the doubling in HRT prescriptions](/blog/hrt-prescriptions-doubling/)."
        },
        {
          "t": "p",
          "text": "There is also a reason to be careful about where the advice comes from. Dr Becky Lynn, a menopause practitioner certified by The Menopause Society, describes an ecosystem of supplements, gadgets and unregulated products sold on fear and distrust of doctors — hundreds of them on TikTok Shop alone. Her rule is a good one: if someone is selling you the product, you cannot take their word for the evidence."
        },
        {
          "t": "h",
        ...
        },
        {
          ...
          "items": [
            {
              "claim": "Menopause symptoms cost the US at least $5.4 billion a year in lost productivity.",
              "detail": "The Economic Impacts of Menopause in the United States (Heissel, Donofry, Bonheur, Shinnick, Rollison and Troxel; RAND Corporation, RR-A4292-1, 2025) estimates $5.4 billion in annual lost productivity from missed workdays, reduced hours and layoffs, with roughly 30% of women in the US labour force aged 45–60. The authors describe the figure as a conservative lower bound that excludes early retirement, missed promotions and moves to lower-paying work, and note the impact is likely to grow as more working-age women reach the transition. This is an economic modelling study built on existing survey and labour-force data, not a trial.",
              "cite": "RAND Corporation · RR-A4292-1, 2025",
              "url": "https://www.rand.org/pubs/research_reports/RRA4292-1.html"
            },
            {
              "claim": "HRT use collapsed after the 2003 black box warning, and the FDA has now removed it.",
              "detail": "Reporting by KBIA (Rebecca Smith, 14 July 2026) sets out the sequence: the FDA imposed a black box warning in 2003 on early Women's Health Initiative findings; University of Vermont research published in 2012 found use fell more than 46% within a few years; Mayo Clinic data put use among women aged 40+ at 1.7% by 2023. Reanalysis for women under 60 or within ten years of menopause onset found the risks dramatically reduced or non-existent, supported by a 2015 meta-analysis and subsequent observational follow-up. The FDA announced withdrawal of the warning in November 2025 and approved the first prescribing information without it in February 2026. The benefit figures in the FDA's 2025 press release — a 50% reduction in heart attack risk, 64% reduction in cognitive decline and 35% lower Alzheimer's risk — are reported as associations, and the supporting evidence is largely observational rather than randomised.",
              "cite": "KBIA · 14 July 2026",
              "url": "https://www.kbia.org/kbia-news/2026-07-14/menopause-is-not-harmless-access-to-treatment-could-reduce-economic-loss"
            }
          ]
        },
        {
          ...
          "items": [
            {
              ...
              "desc": "What changed after the FDA dropped its strongest warning — and why patches are now in short supply."
            },
            {
              "name": "Menopause brain fog isn't early dementia",
              "url": "/blog/menopause-brain-fog-not-dementia/",
              "desc": "The symptom most likely to affect your work, and what a 2026 Lancet review says it actually is."
            },
            {
      ...
      "faq": [
        {
          "q": "Does the $5.4 billion figure mean menopause makes women worse at their jobs?",
          "a": "No — and the report's authors are explicit about that. The estimate measures what untreated symptoms cost in missed workdays, reduced hours and layoffs, in a workforce where roughly 30% of women are in the 45–60 age range. The argument RAND makes is about missing support and access to treatment, not about capability. Sleep loss and hot flushes affect anyone's output; the difference is whether the workplace and the health system do anything about them."
        },
        {
          "q": "Should I ask about hormone therapy if my symptoms affect my work?",
          "a": "It's a reasonable thing to raise. The clinical view quoted in this reporting is that symptoms occurring daily, or interfering with how you function, warrant a proper conversation about the options — you don't need to wait until things reach a crisis. That said, hormone therapy isn't right for everyone; other causes of the same symptoms should be checked, and some forms are unsuitable for anyone with a history of blood clots, stroke or an oestrogen-sensitive cancer. That's a decision to make with your own doctor, who knows your history."
        }
      ]
    },
    "ua": {
      ...
      "excerpt": "Звіт RAND оцінює втрати продуктивності через симптоми менопаузи у 5,4 мільярда доларів на рік у США — і зазначає, що ця цифра свідомо не враховує ранній вихід на пенсію, втрачені підвищення та перехід на нижчу посаду.",
      "meta": "18 серпня 2026 · 4 хв читання",
      "lead": "Близько 30% жінок у складі робочої сили США мають від 45 до 60 років — саме той вік, який найбільше асоціюється з менопаузою. Це не нішева група, і ціна того, що їхні симптоми лишаються без лікування, тепер має конкретну цифру.",
      "blocks": [
        {
          "t": "p",
          "text": "Цифра походить зі звіту RAND за 2025 рік «The Economic Impacts of Menopause in the United States». Оцінка — 5,4 мільярда доларів на рік втраченої продуктивності: пропущені робочі дні, скорочені години та звільнення. Але цитувати варто не через розмір суми, а через те, як її порахували: автори називають її консервативною нижньою межею, яка не враховує ранній вихід на пенсію, втрачені підвищення та перехід на нижчеоплачувану роботу. Реальна ціна вища за неї, а не десь поруч."
        },
        {
          "t": "p",
          "text": "Докторка Венді Трокссел, старша наукова співробітниця RAND і одна з авторок звіту, наголошує саме на часі. Менопауза припадає рівно на той період, коли кар'єра й експертиза жінки на піку. Симптоми, які лишаються без підтримки, зупиняють людину саме тоді, коли вона мала б вийти на повну силу. За її словами в коментарі KBIA, мета звіту — не сказати, що жінки «зламані» цим переходом, а що велика й важлива частина робочої сили має отримати доступ до лікування, яке працює."
        },
        {
          "t": "p",
          "text": "Симптоми, які завдають шкоди на роботі, — цілком звичайні: порушений сон, припливи, туман у голові, дратівливість, знижений настрій. Нічого екзотичного — і почасти саме тому на них махають рукою. Докторка Лорен Страйкер, засновниця Northwestern Medicine Center for Sexual Medicine and Menopause, додає складнішу тезу про те, чого коштує нелікована менопауза поза продуктивністю: проблеми з психічним здоров'ям, остеопороз і підвищений ризик серцево-судинних захворювань та інсульту. Менопауза, за її формулюванням, не є нешкідливою — і це не питання «вдягатися шарами й носити віяло»."
        },
        {
          "t": "p",
          "text": "У прогалини з лікуванням є конкретна історія. 2003 року FDA додало попередження в чорній рамці до гормональної терапії після перших даних Women's Health Initiative, які вказували на підвищені ризики раку грудей, інфаркту, інсульту й тромбів. Використання обвалилося — дослідження Університету Вермонту, опубліковане 2012 року, показало падіння більш ніж на 46% за кілька років, а за даними клініки Мейо, до 2023 року серед жінок від 40 років ЗГТ отримували лише 1,7%. Первинна вибірка дослідження була старшою за жінок, які зазвичай починають лікування, і повторний аналіз для жінок до 60 років або в межах десяти років від настання менопаузи показав, що ризики різко нижчі або відсутні. FDA оголосило про намір скасувати попередження в листопаді 2025 року й затвердило першу інструкцію без нього в лютому 2026-го."
        },
        {
          "t": "p",
          "text": "У пресрелізі FDA 2025 року також названо зв'язок гормональної терапії зі зниженням ризику інфаркту на 50%, когнітивного зниження — на 64% і хвороби Альцгеймера — на 35%, а також зі зниженням загальної смертності та меншою кількістю переломів. Ці цифри варто читати уважно, а не переказувати навпростець: це асоціації, здебільшого з обсерваційних даних щодо жінок, які почали лікування рано, а обсерваційні дані не відділяють ефект терапії від того, кому її призначають. Найкраще доказово підкріплена саме допомога від симптомів — і вона настає швидко. Докторка Ліза Бреннаман, акушерка-гінекологиня University of Missouri Health Care, каже, що покращення зазвичай видно приблизно за сім днів від початку."
        },
        {
          "t": "p",
          "text": "Це не означає, що гормональна терапія підходить усім. Сама Бреннаман застерігає, що варто шукати й інші причини тих самих симптомів, і що деякі форми не підходять тим, хто має в анамнезі тромбози, інсульт або естрогенчутливий рак. Корисна для читачки думка — про поріг звернення: симптоми, які трапляються щодня або заважають функціонувати, заслуговують на розмову про варіанти; не треба доводити до втрати роботи, перелому чи повного виснаження. Ширшу картину того, як змінилися призначення після скасування попередження, я описувала в тексті про [подвоєння призначень ЗГТ](/ua/blog/hrt-prescriptions-doubling/)."
        },
        {
          "t": "p",
          "text": "Є ще причина уважно дивитися, звідки поради. Докторка Бекі Лінн, практикиня з менопаузи, сертифікована The Menopause Society, описує цілу екосистему добавок, гаджетів і нерегульованих продуктів, які продають на страху та недовірі до лікарів — лише в TikTok Shop їх сотні. Її правило просте: якщо людина продає вам продукт, її слова про докази не можна брати на віру."
        },
        {
          "t": "h",
          "text": "Що каже наука"
        },
        {
          ...
          "items": [
            {
              "claim": "Симптоми менопаузи коштують США щонайменше 5,4 мільярда доларів на рік втраченої продуктивності.",
              "detail": "У звіті «The Economic Impacts of Menopause in the United States» (Heissel, Donofry, Bonheur, Shinnick, Rollison, Troxel; RAND Corporation, RR-A4292-1, 2025) оцінено 5,4 мільярда доларів щорічних втрат продуктивності через пропущені робочі дні, скорочені години та звільнення; близько 30% жінок у складі робочої сили США мають 45–60 років. Автори описують цифру як консервативну нижню межу, що не враховує ранній вихід на пенсію, втрачені підвищення та перехід на нижчеоплачувану роботу, і зазначають, що вплив, імовірно, зростатиме. Це економічне моделювання на основі наявних опитувань і даних про робочу силу, а не клінічне дослідження.",
              "cite": "RAND Corporation · RR-A4292-1, 2025",
              "url": "https://www.rand.org/pubs/research_reports/RRA4292-1.html"
            },
            {
              "claim": "Після попередження в чорній рамці 2003 року використання ЗГТ обвалилося — тепер FDA його скасувало.",
              "detail": "Матеріал KBIA (Rebecca Smith, 14 липня 2026) викладає послідовність: 2003 року FDA запровадило попередження в чорній рамці на підставі перших результатів Women's Health Initiative; дослідження Університету Вермонту 2012 року показало падіння використання більш ніж на 46% за кілька років; за даними клініки Мейо, до 2023 року серед жінок від 40 років використання становило 1,7%. Повторний аналіз для жінок до 60 років або в межах десяти років від настання менопаузи показав різко менші або відсутні ризики, що підтверджено метааналізом 2015 року та подальшими обсерваційними дослідженнями. FDA оголосило про скасування попередження в листопаді 2025 року й затвердило першу інструкцію без нього в лютому 2026-го. Наведені в пресрелізі FDA 2025 року цифри користі — зниження ризику інфаркту на 50%, когнітивного зниження на 64% і хвороби Альцгеймера на 35% — подано як асоціації, і докази за ними здебільшого обсерваційні, а не рандомізовані.",
              "cite": "KBIA · 14 липня 2026",
              "url": "https://www.kbia.org/kbia-news/2026-07-14/menopause-is-not-harmless-access-to-treatment-could-reduce-economic-loss"
            }
          ]
        },
          ...
          "items": [
            {
              ...
              "desc": "Що змінилося після скасування найсуворішого попередження FDA — і чому бракує пластирів."
            },
            {
              "name": "Туман у голові при менопаузі — це не рання деменція",
              "url": "/ua/blog/menopause-brain-fog-not-dementia/",
              "desc": "Симптом, який найбільше б'є по роботі, і що це насправді таке за оглядом The Lancet 2026 року."
            },
            {
      ...
      "faq": [
        {
          "q": "Чи означає цифра в 5,4 мільярда, що менопауза робить жінок гіршими працівницями?",
          "a": "Ні — і авторки звіту говорять про це прямо. Оцінка вимірює, у що обходяться неліковані симптоми через пропущені дні, скорочені години та звільнення, у робочій силі, де близько 30% жінок мають 45–60 років. Аргумент RAND — про брак підтримки й доступу до лікування, а не про здатність працювати. Недосипання й припливи б'ють по результативності будь-кого; різниця в тому, чи робить із цим щось роботодавець і система охорони здоров'я."
        },
        {
          "q": "Чи варто питати про гормональну терапію, якщо симптоми заважають працювати?",
          "a": "Це слушне питання, щоб його підняти. Клінічна позиція, наведена в цьому матеріалі: симптоми, які трапляються щодня або заважають функціонувати, варті повноцінної розмови про варіанти — не треба чекати кризи. Водночас гормональна терапія підходить не всім: слід перевірити й інші причини тих самих симптомів, а деякі форми не підходять тим, хто має в анамнезі тромбози, інсульт або естрогенчутливий рак. Це рішення ухвалюють разом із власним лікарем, який знає вашу історію."
        }
      ]
    }
  },
  {
    "slug": "clinical-trials-women-over-40",
    "date": "2026-08-17",
    "image": "/images/clinical-trials-women-over-40.jpg",
    "cats": [
      "perimenopause",
      "diabetes"
    ],
    "en": {
      ...
      "blocks": [
        {
          "t": "p",
          "text": "I write a lot about the gaps — how thin the evidence is on perimenopause and blood sugar, how rarely trials report results separately for women. The other side of that is worth saying out loud: gaps get filled by studies, and studies need participants. If you have ever read one of my articles and thought \"why doesn't anybody know this yet\", this is the page where you can do something about it."
        },
        {
          "t": "p",
          "text": "There is a self-interested case too, and I don't think it needs apologising for. Taking part usually means more measurement than you would ever get routinely — body composition scans, continuous glucose data, detailed bloods — plus time with a team who are paying close attention to exactly the thing bothering you. It is not treatment, and it should never replace your own care. But for a lot of women it is the most thorough look at their own physiology they will get."
        },
        {
          "t": "h",
        ...
        {
          "t": "p",
          "text": "Every study below was recruiting when I checked it on 17 August 2026, and I dropped several that still said \"recruiting\" but whose recruitment window had already closed. Registries move constantly, so treat the linked page as the truth and this list as a signpost — each registry record has the study team's contact details, usually near the bottom. Where a study is UK-based I have named the city, because the single biggest reason people drop out of a trial is the travel."
        },
        {
          "t": "p",
          "text": "Nothing here is a recommendation, and I have no involvement in any of these studies. Some are drug trials with real side-effect profiles; several are supplement or probiotic studies that are, honestly, early-stage science with modest expectations attached. Read the eligibility criteria before you get attached to one — and if you take insulin or any prescribed medicine, talk to your own team before you apply, not after."
        },
        {
          "t": "h",
          "text": "Perimenopause and menopause symptoms"
        },
        {
          "t": "p",
        ...
        {
          "t": "links",
          "title": "Perimenopause and menopause studies",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07590999",
              "desc": "Whether a multi-strain probiotic shifts emotional processing, memory and concentration, with cortisol, immune markers and gut-microbiome measures alongside. Women 45–60 in perimenopause who have hot flushes plus mild to moderate mood, cognitive or joint symptoms. University of Oxford, 106 places, running to mid-2027."
            },
            {
              "name": "Myo-inositol, berberine, cinnamon and chromium for body composition — Southampton",
              "url": "https://clinicaltrials.gov/study/NCT07615777",
              "desc": "A 12-week supplement pilot measuring body composition and blood metabolites. Women 38–55 with irregular cycles, or at least one recent symptom from hot flushes, disturbed sleep, mood swings, concentration problems, bloating or weight gain. University of Southampton, 80 places, finishing December 2026."
            },
            {
              "name": "A probiotic drink for menopausal skin inflammation — London",
              "url": "https://clinicaltrials.gov/study/NCT07341087",
              "desc": "Eight weeks of a Lactobacillus casei Shirota drink or a skimmed-milk control, measuring immune ageing, inflammation and facial skin. Women 40–60 with non-infectious inflammatory skin on the face — rosacea, acne or eczema. King's College London, 30 places, running to late 2027. Blood, skin and stool samples are part of it."
            },
            {
        ...
        {
          "t": "h",
          "text": "Muscle, strength and body composition after 40"
        },
        {
          "t": "p",
          "text": "Muscle is the quiet story of the forties onwards, and it is finally being studied in women specifically rather than extrapolated from men. Both of these are small, and both are the kind of study where you learn something concrete about your own body. If you want to know why I keep going on about this, see [strength training in perimenopause](/blog/strength-training-perimenopause-beginners/) and [protein for women over 40](/blog/protein-for-women-over-40/)."
        },
        {
          "t": "links",
          "title": "Muscle and body-composition studies",
          "items": [
            {
              "name": "Creatine and other supplements for women in midlife — Loughborough",
              "url": "https://clinicaltrials.gov/study/NCT07729930",
              "desc": "Eight weeks of supplements or placebo against the complaints women actually report in midlife: joint pain, fatigue, sleep, strength, body composition and inflammation. Healthy non-smoking women 35–65 with a BMI of 18–30, either recreationally active or sedentary. Loughborough University, 38 places."
            },
            {
        ...
        {
          "t": "h",
          "text": "Type 2 diabetes, prediabetes and remission"
        },
        {
          "t": "p",
          "text": "Two very different offers here: one is fundamental research into what fat in the pancreas does and what weight loss undoes, the other is a chance to use technology years before it reaches ordinary type 2 care. Note that the Edinburgh study takes postmenopausal women only — deliberately, to remove sex hormones as a variable, which is the same design choice that produced the evidence gap in the first place. My [metabolic food calculator](/resources/food-calculator/) is a reasonable place to start if you are thinking about your own diet in the meantime."
        },
        {
          "t": "links",
          "title": "Type 2 diabetes studies",
          "items": [
            {
              "name": "Edinburgh Diabetes Remission Study — pancreas fat and what weight loss reverses",
              "url": "https://clinicaltrials.gov/study/NCT07364045",
              "desc": "How fat inside the pancreas drives type 2 diabetes, and which part of that weight loss undoes. Ages 45–79 with a BMI of 30–45, in four groups: type 2 diabetes for under 6 years, for over 10 years, prediabetes, or none of those as a comparison. Women must be postmenopausal, because the study is deliberately controlling for sex hormones. University of Edinburgh, 104 places."
            },
            {
              "name": "An artificial pancreas for type 2 diabetes on insulin — six UK cities",
              "url": "https://clinicaltrials.gov/study/NCT06579404",
              "desc": "26 weeks of fully automated insulin delivery versus standard insulin therapy — the closed-loop technology that transformed type 1 care, tested in type 2. Adults with type 2 diabetes for at least a year, on insulin for at least six months, HbA1c up to 15%. Cambridge, Derby, Leicester, London, Manchester and Norwich, plus five other countries. 224 places, led from Cambridge."
            }
          ]
        },
        {
          "t": "h",
          "text": "Type 1 diabetes in adults"
        },
        {
          "t": "p",
          "text": "Adult type 1 research has moved decisively towards the problems that actually shape daily life — losing hypo warning signs, and the heart. If you live with type 1 and want to see the cure-directed research separately, I keep a [tracker of the type 1 cure trials](/blog/type-1-diabetes-cure-trials/) updated with what is in progress and what has failed. And if exercise is the variable you are trying to predict, the [exercise and blood sugar calculator](/resources/exercise-calculator/) estimates how different training is likely to move your glucose."
        },
        {
          "t": "links",
          "title": "Type 1 diabetes studies",
          "items": [
            {
              "name": "CLEAR: getting your hypo warning signs back — Leicester and Sheffield",
              "url": "https://clinicaltrials.gov/study/NCT06325202",
        ...
        {
          "t": "h",
          "text": "Weight-loss medicines"
        },
        {
          "t": "p",
          "text": "Tirzepatide and semaglutide trials are everywhere, and most take men and women without asking anything about menopause. This one is here because it is pragmatic — real settings, five years, an actual comparison against standard care — and because it recruits widely rather than at one research unit. On the muscle question that hangs over these drugs, see [what the fat-versus-muscle data actually show](/blog/glp1-weight-loss-drugs-fat-not-muscle/), and the Exeter exercise study above."
        },
        {
          "t": "links",
          "title": "Weight-medicine studies",
          "items": [
            {
              "name": "SURMOUNT-REAL UK: tirzepatide against usual weight-management care",
              "url": "https://clinicaltrials.gov/study/NCT07247084",
              "desc": "A 3,000-person phase 4 study running in everyday clinical settings rather than a research unit, comparing weekly tirzepatide with standard care over roughly five years, including whether type 2 diabetes develops. Adults with a BMI of 30–34.9, a waist-to-height ratio above 0.5, at least one weight-related condition, no diabetes, and at least one previous attempt at losing weight through diet and activity. Sites across Greater Manchester and Cheshire."
            }
          ]
        },
        {
          "t": "h",
          "text": "Heart health after menopause"
        },
        {
          "t": "p",
        ...
        },
        {
          ...
          "items": [
            {
              "name": "Barts Sex-CAD: why heart protection disappears after menopause",
              "url": "https://clinicaltrials.gov/study/NCT06327984",
              "desc": "A long-running London database linking female sex-hormone levels to inflammation and coronary artery disease, built to answer why women lose their pre-menopausal protection and then do worse than men after a heart attack. Open to anyone 16 or over arriving at Barts Heart Centre with chest pain: you consent to your samples and data being studied, there is no treatment and nothing changes about your care. 6,000 people, collecting until 2033."
            }
          ]
        },
        {
          "t": "h",
          "text": "Recruiting in Ukraine"
        },
        {
          "t": "p",
        ...
        {
          "t": "links",
          "title": "Studies recruiting in Ukraine",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07662135",
              "desc": "The companion phase 3 study for people whose kidney function is impaired, on background dapagliflozin. Same diabetes and BMI criteria, HbA1c 7–10.5% on a stable SGLT2 inhibitor or 7.5–10.5% without one. 900 places; UK sites include Glasgow, Hull and Blackpool."
            },
            {
              "name": "Continuous glucose monitoring in prediabetes — Kyiv",
              "url": "https://clinicaltrials.gov/study/NCT07599072",
              "desc": "A randomised study of whether three months of real-time glucose monitoring improves control and makes lifestyle changes stick, compared with ordinary finger-prick testing. Adults with prediabetes managed by diet and exercise or a stable metformin dose. Kyiv, 80 places, running to spring 2027."
            },
            {
              "name": "Continuous glucose monitoring in newly diagnosed type 2 diabetes — Kyiv",
              "url": "https://clinicaltrials.gov/study/NCT07690163",
              "desc": "The same question in people diagnosed within the last three months, with HbA1c between 6.5% and 9.5%, on lifestyle measures or non-insulin medication. Bogomolets National Medical University, Kyiv. 80 places, running to March 2027."
            }
          ]
        },
        {
          "t": "h",
          "text": "Studies you can join without a diagnosis"
        },
        {
          "t": "p",
          "text": "If nothing above fits, this is the useful move: get yourself into the pool that researchers recruit from. One appointment, and you become findable."
        },
        {
          "t": "links",
          "title": "Open to volunteers",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07125365",
              "desc": "For people who already know they carry islet autoantibodies — the blood markers that can precede type 1 diabetes by months or years. The registry follows what happens next and makes it easier to be offered prevention studies. Ages six months to 70, living in the UK, at least one confirmed positive antibody. 350 people."
            }
          ]
        },
        {
          "t": "h",
          "text": "What to ask before you say yes"
        },
        {
          "t": "p",
          "text": "Every approved study has to answer all of these, and a good research team will answer them before you ask. Print this, or take it to the phone call."
        },
        {
          "t": "table",
          "head": [
          ...
          "rows": [
            [
              "What happens at each visit, and how many visits are there?",
              "Blood draws, scans, skin or fat biopsies and fasting early starts are all normal in these studies. The registry record lists the procedures; it is the number of visits and the travel that people underestimate."
            ],
            [
              "Could I be given a placebo, and would I know?",
              "In most of the studies above, yes to the first. Double-blind means nobody tells you which group you are in until the end — not even the researchers know while it runs."
            ],
            [
              "Can I stop?",
              "Always, at any point, without giving a reason, and without it affecting your NHS care. If anyone suggests otherwise, that is your answer about the study."
            ],
            [
              "Are expenses paid?",
              "UK academic studies normally reimburse travel and sometimes add a modest payment for your time; commercial trials more often do. It is never rude to ask before you commit."
            ],
            [
              "Do I have to come off HRT, contraception or supplements?",
              "Several studies here exclude women using hormone therapy or specific supplements. Never stop something you were prescribed in order to qualify — ask the clinician who prescribed it first."
            ],
            [
              "Will I get my own results?",
              "Sometimes: scans, body composition, glucose traces and bloods are often shared. Sometimes nothing comes back until publication. Ask, because for many women this is the real reward."
            ],
            [
              "Who is my named contact, and will my GP be told?",
              "Every approved study has a named researcher on the registry page. Most will write to your GP with your permission, which is worth agreeing to so your notes match your life."
            ]
          ]
        },
        {
          "t": "h",
          "text": "How to find the ones I have missed"
        },
        {
          "t": "p",
          "text": "This list is what suited my readers — women over 40, mostly in the UK and Ukraine, mostly interested in hormones and metabolic health. It is a slice of what is out there, and it will be out of date within months. These three are how to look for yourself."
        },
        {
          "t": "links",
          "title": "Search the registries yourself",
          "items": [
            {
              "name": "Be Part of Research — the NHS study finder",
              "url": "https://bepartofresearch.nihr.ac.uk/",
              "desc": "The official UK service: tell it which conditions you care about and it matches you to studies across England, Scotland, Wales and Northern Ireland. Free, and the closest thing to a single door into NHS research."
            },
            {
              "name": "ClinicalTrials.gov",
              "url": "https://clinicaltrials.gov/",
              "desc": "The registry everything in this article was checked against. Search by condition and country, and filter to 'recruiting' — the contact details for each study team are near the bottom of every record."
            },
            {
              "name": "ISRCTN registry",
              "url": "https://www.isrctn.com/",
              "desc": "Many UK academic and NHS studies register here instead of, or as well as, ClinicalTrials.gov. Worth a second search — the ELSA type 1 screening study, for one, only appears here."
            }
          ]
        },
        {
        ...
        {
          "t": "p",
          "text": "The sources behind the list itself, and behind the claim that research has been slow to include women of this age."
        },
        {
          "t": "refs",
          "items": [
            {
              "claim": "Every study in this list was recruiting on the day this was published.",
              "detail": "Each entry was checked individually against its own registry record on 17 August 2026: recruitment status, age and sex eligibility, the cities actually listed as sites, planned end date and the date the record was last updated by the study team. Studies whose recruitment window had already closed were dropped even where the registry still read 'recruiting'. Records are maintained by the teams themselves, so the registry page always outranks this article — check it before you contact anyone.",
              "cite": "ClinicalTrials.gov · US National Library of Medicine registry",
              "url": "https://clinicaltrials.gov/"
            },
            {
              "claim": "Women were only required to be included in publicly funded US research from 1993.",
              "detail": "The NIH Revitalization Act of 1993 (Public Law 103-43, 107 Stat. 122) obliged the National Institutes of Health to include women and members of minority groups in clinical research, and to make sure trials were large enough to analyse differences between them. Before that, inclusion was encouraged by guidance rather than required, and earlier US guidance had explicitly kept women who could become pregnant out of early-phase trials. That is one generation of research, not ancient history — it is a large part of why questions about perimenopause still have thin answers.",
              "cite": "NIH Revitalization Act of 1993, Public Law 103-43 (statute text)",
              "url": "https://www.govinfo.gov/content/pkg/STATUTE-107/pdf/STATUTE-107-Pg122.pdf"
            },
            {
      ...
      "faq": [
        {
          ...
          "a": "Usually not in the sense of a wage. UK academic studies normally reimburse travel and sometimes offer a modest payment for your time, particularly where visits are long or involve procedures like biopsies; commercial drug trials pay more often. The registry record rarely states it clearly, so ask the study team directly — it is a completely standard question and asking it will not affect whether you are accepted."
        },
        {
        ...
        },
        {
          ...
          "a": "Of some studies, yes. Several trials of non-hormonal approaches specifically exclude women currently using hormone therapy, and one in this list asks for a year without it — because they cannot tell whether an effect came from their supplement or your patches. That is scientifically reasonable and practically annoying. What you should not do is come off HRT to qualify. Talk to whoever prescribes it, and look for a study whose criteria you already fit."
        },
        {
          "q": "Is it safe, and what if I get the placebo?",
          "a": "Every study here has been through an ethics committee, which is what the registry record and its approval numbers represent. That does not mean zero risk: drug trials carry the side effects of the drug and are monitored accordingly, while the supplement and probiotic studies carry very little. You may well be in the placebo group, and in a double-blind study nobody involved knows who is until it ends. You can withdraw at any point, for any reason, without it affecting your normal care — that is not a courtesy, it is a condition of the study being allowed to run."
        },
        {
          "q": "Do I need a referral from my GP?",
          "a": "Almost never. Most of these studies recruit directly and you can contact the team yourself using the details on the registry page. Many will then ask your permission to write to your GP, and it is worth saying yes so your medical record reflects what you are actually taking or wearing. If a study needs your clinical data — HbA1c, scans, prescriptions — they will ask you to consent to that separately."
        }
      ]
    },
    "ua": {
      ...
      "blocks": [
        {
          "t": "p",
          "text": "Я багато пишу про прогалини: наскільки мало ми знаємо про перименопаузу і цукор у крові, як рідко дослідження подають результати окремо для жінок. Але є й інший бік, і його варто сказати прямо: прогалини закривають дослідження, а дослідженням потрібні учасниці. Якщо ви колись читали мою статтю й думали «чому цього досі ніхто не знає» — ось сторінка, де з цим можна щось зробити."
        },
        {
          "t": "p",
          "text": "Є й цілком егоїстичний аргумент, і за нього не треба вибачатися. Участь зазвичай означає більше обстежень, ніж ви отримаєте в звичайному житті: сканування складу тіла, безперервні дані про глюкозу, докладні аналізи — плюс час із командою, яка пильно дивиться саме на те, що вас турбує. Це не лікування і не має його заміняти. Але для багатьох жінок це найдетальніший погляд на власну фізіологію, який їм узагалі доступний."
        },
        {
          "t": "h",
          "text": "Як користуватися цим списком"
        },
        {
          "t": "p",
          "text": "Кожне дослідження нижче набирало учасників, коли я перевіряла його 17 серпня 2026 року, і кілька я прибрала: у них досі стояло «recruiting», хоча період набору вже завершився. Реєстри змінюються постійно, тому вважайте істиною сторінку за посиланням, а цей список — вказівником. У кожному записі реєстру є контакти дослідницької групи, зазвичай у кінці. Для британських досліджень я назвала місто, бо найчастіша причина, чому люди виходять із дослідження, — це дорога."
        },
        {
          "t": "p",
          "text": "Ніщо тут не є рекомендацією, і я не маю стосунку до жодного з цих досліджень. Частина — це випробування ліків із реальними побічними ефектами; кілька — дослідження добавок і пробіотиків, тобто, якщо чесно, рання наука зі скромними очікуваннями. Прочитайте критерії, перш ніж прив'язатися до якогось варіанта. А якщо ви на інсуліні або будь-яких призначених ліках, поговоріть зі своєю командою до того, як подаватися, а не після."
        },
        {
          "t": "h",
          "text": "Симптоми перименопаузи та менопаузи"
        },
        {
          "t": "p",
        ...
        {
          "t": "links",
          "title": "Дослідження перименопаузи та менопаузи",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07590999",
              "desc": "Чи змінює багатоштамовий пробіотик емоційну обробку інформації, пам'ять і концентрацію — разом із кортизолом, маркерами імунітету та мікробіомом. Жінки 45–60 років у перименопаузі, у яких є припливи плюс легкі чи помірні порушення настрою, мислення або біль у суглобах. Оксфордський університет, 106 місць, до середини 2027 року."
            },
            {
              "name": "Міоінозитол, берберин, кориця і хром для складу тіла — Саутгемптон",
              "url": "https://clinicaltrials.gov/study/NCT07615777",
              "desc": "12-тижневе пілотне дослідження добавки: склад тіла та метаболіти крові. Жінки 38–55 років із нерегулярним циклом або щонайменше одним свіжим симптомом — припливи, порушення сну, різкі зміни настрою, проблеми з концентрацією, здуття чи набір ваги. Університет Саутгемптона, 80 місць, завершується в грудні 2026 року."
            },
            {
              "name": "Пробіотичний напій проти запалення шкіри в менопаузі — Лондон",
              "url": "https://clinicaltrials.gov/study/NCT07341087",
              "desc": "Вісім тижнів напою з Lactobacillus casei Shirota або знежиреного молока як контролю: маркери старіння імунітету, запалення і стан шкіри обличчя. Жінки 40–60 років із неінфекційним запальним станом шкіри обличчя — розацеа, акне або екзема. Королівський коледж Лондона, 30 місць, до кінця 2027 року. Потрібні зразки крові, шкіри та калу."
            },
            {
        ...
        {
          "t": "h",
          "text": "М'язи, сила і склад тіла після 40"
        },
        {
          "t": "p",
          "text": "М'язи — тиха головна історія після сорока, і її нарешті вивчають саме на жінках, а не переносять висновки з чоловіків. Обидва дослідження невеликі, і обидва з тих, де ви дізнаєтесь щось конкретне про власне тіло. Чому я про це не замовкаю — у текстах [силові тренування в перименопаузі](/ua/blog/strength-training-perimenopause-beginners/) та [білок для жінок після 40](/ua/blog/protein-for-women-over-40/)."
        },
        {
          "t": "links",
          "title": "Дослідження м'язів і складу тіла",
          "items": [
            {
              "name": "Креатин та інші добавки для жінок середнього віку — Лафборо",
              "url": "https://clinicaltrials.gov/study/NCT07729930",
              "desc": "Вісім тижнів добавок або плацебо — і саме ті скарги, про які жінки після 40 говорять найчастіше: біль у суглобах, втома, сон, сила, склад тіла, запалення. Здорові жінки 35–65 років, які не курять, з ІМТ 18–30, або фізично активні, або малорухливі. Університет Лафборо, 38 місць."
            },
            {
        ...
        {
          "t": "h",
          "text": "Діабет 2 типу, предіабет і ремісія"
        },
        {
          "t": "p",
          "text": "Тут дві дуже різні пропозиції: одна — фундаментальне дослідження того, що робить жир у підшлунковій і що скасовує втрата ваги, друга — можливість користуватися технологією за роки до того, як вона дійде до звичайної допомоги при 2 типі. Зверніть увагу: единбурзьке дослідження бере лише жінок у постменопаузі — свідомо, щоб прибрати статеві гормони як змінну. Це той самий вибір дизайну, який і створив прогалину в знаннях. Поки що непогана точка старту для власного харчування — мій [калькулятор метаболічної цінності їжі](/ua/resources/food-calculator/)."
        },
        {
          "t": "links",
          "title": "Дослідження діабету 2 типу",
          "items": [
            {
              "name": "Единбурзьке дослідження ремісії діабету — жир у підшлунковій і що скасовує втрата ваги",
              "url": "https://clinicaltrials.gov/study/NCT07364045",
              "desc": "Як жир усередині підшлункової залози спричиняє діабет 2 типу і що саме з цього скасовує зниження ваги. Вік 45–79 років, ІМТ 30–45, чотири групи: діабет 2 типу менше 6 років, більше 10 років, предіабет або жодного з цього (для порівняння). Жінки — лише в постменопаузі, бо дослідження свідомо виключає вплив статевих гормонів. Единбурзький університет, 104 місця."
            },
            {
              "name": "Штучна підшлункова при діабеті 2 типу на інсуліні — шість міст Великої Британії",
              "url": "https://clinicaltrials.gov/study/NCT06579404",
              "desc": "26 тижнів повністю автоматичної подачі інсуліну проти звичайної інсулінотерапії: технологія замкненого контуру, яка змінила життя при 1 типі, тепер перевіряється при 2 типі. Дорослі з діабетом 2 типу щонайменше рік, на інсуліні щонайменше пів року, HbA1c до 15%. Кембридж, Дербі, Лестер, Лондон, Манчестер і Норвіч плюс п'ять інших країн. 224 місця."
            }
          ]
        },
        {
          "t": "h",
          "text": "Діабет 1 типу в дорослих"
        },
        {
          "t": "p",
          "text": "Дослідження дорослого 1 типу помітно розвернулися до проблем, які насправді визначають щоденне життя: втрата відчуття гіпоглікемії та серце. Якщо ви живете з 1 типом і хочете бачити окремо дослідження, спрямовані на зцілення, я веду [трекер досліджень лікування діабету 1 типу](/ua/blog/type-1-diabetes-cure-trials/) — що триває і що провалилося. А якщо змінна, яку ви намагаєтеся передбачити, — це фізична активність, [калькулятор фізичних навантажень і цукру](/ua/resources/exercise-calculator/) оцінює, як різні тренування ймовірно зрушать вашу глюкозу."
        },
        {
          "t": "links",
          "title": "Дослідження діабету 1 типу",
          "items": [
            {
              "name": "CLEAR: повернути відчуття гіпоглікемії — Лестер і Шеффілд",
              "url": "https://clinicaltrials.gov/study/NCT06325202",
        ...
        {
          "t": "h",
          "text": "Препарати для зниження ваги"
        },
        {
          "t": "p",
          "text": "Досліджень тирзепатиду й семаглутиду зараз безліч, і більшість беруть і чоловіків, і жінок, нічого не питаючи про менопаузу. Це тут тому, що воно прагматичне — звичайні клінічні умови, п'ять років, справжнє порівняння зі стандартною допомогою — і тому, що набір іде широко, а не в одному дослідному центрі. Про питання м'язів, яке висить над цими препаратами, — [що насправді показують дані про жир і м'язи](/ua/blog/glp1-weight-loss-drugs-fat-not-muscle/), і дослідження в Ексетері вище."
        },
        {
          "t": "links",
          "title": "Дослідження препаратів для ваги",
          "items": [
            {
              "name": "SURMOUNT-REAL UK: тирзепатид проти звичайного лікування ваги",
              "url": "https://clinicaltrials.gov/study/NCT07247084",
              "desc": "Дослідження 4 фази на 3000 людей у звичайних клінічних умовах, а не в дослідному центрі: щотижневий тирзепатид проти стандартної допомоги протягом близько п'яти років, зокрема чи розвинеться діабет 2 типу. Дорослі з ІМТ 30–34,9, співвідношенням обхвату талії до зросту понад 0,5, щонайменше одним станом, пов'язаним із вагою, без діабету і з попередньою спробою схуднути через харчування та активність. Центри у Великому Манчестері та Чеширі."
            }
          ]
        },
        {
          "t": "h",
          "text": "Здоров'я серця після менопаузи"
        },
        {
          "t": "p",
        ...
        {
          "t": "links",
          "title": "Дослідження серця",
          "items": [
            {
              "name": "Barts Sex-CAD: чому після менопаузи зникає захист серця",
              "url": "https://clinicaltrials.gov/study/NCT06327984",
              "desc": "Довготривала лондонська база даних, яка зв'язує рівні жіночих статевих гормонів із запаленням і хворобою коронарних артерій — щоб зрозуміти, чому жінки втрачають захист, який мали до менопаузи, і чому після інфаркту їм гірше, ніж чоловікам. Долучитися може будь-хто від 16 років, хто потрапляє до Barts Heart Centre з болем у грудях: ви даєте згоду на вивчення зразків і даних, лікування не змінюється. 6000 людей, збір до 2033 року."
            }
          ]
        },
        {
          "t": "h",
          "text": "Набір в Україні"
        },
        {
          "t": "p",
        ...
        {
          "t": "links",
          "title": "Дослідження, які набирають в Україні",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07662135",
              "desc": "Паралельне дослідження 3 фази для людей із порушеною функцією нирок, на тлі дапагліфлозину. Ті самі критерії щодо діабету та ІМТ, HbA1c 7–10,5% на стабільній дозі інгібітора SGLT2 або 7,5–10,5% без нього. 900 місць; у Британії — Глазго, Галл, Блекпул."
            },
            {
              "name": "Моніторинг глюкози при предіабеті — Київ",
              "url": "https://clinicaltrials.gov/study/NCT07599072",
              "desc": "Рандомізоване дослідження: чи покращують три місяці безперервного моніторингу глюкози контроль і дотримання змін способу життя порівняно зі звичайними проколами пальця. Дорослі з предіабетом на харчуванні та активності або на стабільній дозі метформіну. Київ, 80 місць, до весни 2027 року."
            },
            {
              "name": "Моніторинг глюкози при щойно виявленому діабеті 2 типу — Київ",
              "url": "https://clinicaltrials.gov/study/NCT07690163",
              "desc": "Те саме питання для людей, яким діагноз поставили в останні три місяці, з HbA1c від 6,5% до 9,5%, на способі життя або неінсулінових препаратах. Національний медичний університет імені О. О. Богомольця, Київ. 80 місць, до березня 2027 року."
            }
          ]
        },
        {
          "t": "h",
          "text": "Дослідження, до яких можна долучитися без діагнозу"
        },
        {
          "t": "p",
          "text": "Якщо нічого вище не підходить, є корисний хід: потрапити в те коло людей, з якого дослідники набирають учасників. Один візит — і вас можна знайти."
        },
        {
          "t": "links",
          "title": "Відкриті для добровольців",
          "items": [
            {
            ...
            },
            {
              ...
              "url": "https://clinicaltrials.gov/study/NCT07125365",
              "desc": "Для людей, які вже знають, що мають острівцеві автоантитіла — маркери в крові, які можуть з'явитися за місяці й роки до діабету 1 типу. Реєстр відстежує, що відбувається далі, і полегшує запрошення до досліджень із профілактики. Від 6 місяців до 70 років, проживання у Великій Британії, щонайменше одне підтверджене антитіло. 350 людей."
            }
          ]
        },
        {
          "t": "h",
          "text": "Що запитати, перш ніж погоджуватися"
        },
        {
          "t": "p",
          "text": "Кожне схвалене дослідження зобов'язане відповісти на всі ці питання, а хороша команда відповість ще до того, як ви їх поставите. Роздрукуйте або тримайте перед собою під час дзвінка."
        },
        {
          "t": "table",
          "head": [
          ...
          "rows": [
            [
              "Що відбувається на кожному візиті і скільки їх усього?",
              "Забір крові, сканування, біопсія шкіри чи жирової тканини, ранні візити натощак — усе це нормально для таких досліджень. Процедури перелічені в реєстрі; люди зазвичай недооцінюють саму кількість візитів і дорогу."
            ],
            [
              "Чи можу я отримати плацебо і чи я про це знатиму?",
              "У більшості досліджень вище — так. Подвійне засліплення означає, що до кінця ніхто не скаже вам, у якій ви групі: під час дослідження цього не знають навіть дослідники."
            ],
            [
              "Чи можу я вийти з дослідження?",
              "Завжди, у будь-який момент, без пояснення причин і без наслідків для вашого звичайного лікування. Якщо хтось намагається переконати в іншому — це вже відповідь про таке дослідження."
            ],
            [
              "Чи компенсують витрати?",
              "Британські академічні дослідження зазвичай компенсують дорогу, іноді додають невелику суму за витрачений час; комерційні — частіше. Запитати про це перед погодженням абсолютно нормально."
            ],
            [
              "Чи потрібно відмовитися від МГТ, контрацепції або добавок?",
              "Кілька досліджень із цього списку не беруть жінок, які приймають гормональну терапію або певні добавки. Ніколи не відміняйте призначене вам лікування, щоб підійти під критерії — спершу поговоріть із лікарем, який його призначив."
            ],
            [
              "Чи отримаю я власні результати?",
              "Іноді так: сканування, склад тіла, графіки глюкози й аналізи часто віддають. Іноді нічого не буде до публікації. Запитайте — для багатьох жінок саме це і є справжня вигода."
            ],
            [
              "Хто моя контактна особа і чи повідомлять мого лікаря?",
              "У кожного схваленого дослідження на сторінці реєстру є конкретний дослідник із контактами. Більшість із вашої згоди напише вашому сімейному лікарю — на це варто погодитися, щоб ваша медична картка відповідала реальності."
            ]
          ]
        },
        {
          "t": "h",
          "text": "Як знайти те, що я пропустила"
        },
        {
          "t": "p",
          "text": "Цей список — те, що підходить моїм читачкам: жінки після 40, переважно у Британії та Україні, переважно з інтересом до гормонів і метаболічного здоров'я. Це лише частина того, що існує, і за кілька місяців він застаріє. Ось три способи шукати самостійно."
        },
        {
          "t": "links",
          "title": "Шукати в реєстрах самостійно",
          "items": [
            {
              "name": "Be Part of Research — офіційний пошук досліджень NHS",
              "url": "https://bepartofresearch.nihr.ac.uk/",
              "desc": "Державний британський сервіс: ви вказуєте, які стани вас цікавлять, і він підбирає дослідження в Англії, Шотландії, Уельсі та Північній Ірландії. Безкоштовно і найближче до єдиних дверей у дослідження NHS."
            },
            {
              "name": "ClinicalTrials.gov",
              "url": "https://clinicaltrials.gov/",
              "desc": "Реєстр, за яким перевірено все в цій статті. Шукайте за станом і країною, ставте фільтр «recruiting» — контакти дослідницької групи є в кінці кожного запису."
            },
            {
              "name": "Реєстр ISRCTN",
              "url": "https://www.isrctn.com/",
              "desc": "Багато британських академічних та NHS-досліджень реєструються тут, а не лише на ClinicalTrials.gov. Варто шукати і там: наприклад, скринінгове дослідження ELSA при діабеті 1 типу є тільки на ISRCTN."
            }
          ]
        },
        {
        ...
        {
          "t": "p",
          "text": "Джерела самого списку — і твердження, що жінок цього віку довго не включали в дослідження."
        },
        {
          "t": "refs",
          "items": [
            {
              "claim": "Кожне дослідження з цього списку набирало учасників на день публікації.",
              "detail": "Кожен запис перевірено окремо за його ж сторінкою в реєстрі 17 серпня 2026 року: статус набору, критерії за віком і статтю, міста, які справді вказані як центри, запланована дата завершення і дата останнього оновлення запису дослідницькою групою. Дослідження, у яких період набору вже завершився, вилучено — навіть якщо в реєстрі досі стояло «recruiting». Записи ведуть самі команди, тому сторінка реєстру завжди важливіша за цю статтю: перевірте її перед тим, як писати комусь.",
              "cite": "ClinicalTrials.gov · реєстр Національної медичної бібліотеки США",
              "url": "https://clinicaltrials.gov/"
            },
            {
              "claim": "Включати жінок у державні дослідження в США стало обов'язково лише з 1993 року.",
              "detail": "Закон NIH Revitalization Act 1993 року (Public Law 103-43, 107 Stat. 122) зобов'язав Національні інститути здоров'я США включати жінок і представників меншин у клінічні дослідження — і робити дослідження достатньо великими, щоб можна було проаналізувати відмінності між групами. До того це радше рекомендували, ніж вимагали, а раніші американські настанови прямо виключали жінок, які могли завагітніти, з досліджень ранніх фаз. Це одне покоління науки, а не сива давнина — і значною мірою саме тому на питання про перименопаузу досі мало ґрунтовних відповідей.",
              "cite": "NIH Revitalization Act 1993, Public Law 103-43 (текст закону)",
              "url": "https://www.govinfo.gov/content/pkg/STATUTE-107/pdf/STATUTE-107-Pg122.pdf"
            },
            {
      ...
      "faq": [
        {
          "q": "Чи платять за участь?",
          "a": "Зазвичай не як за роботу. Британські академічні дослідження компенсують дорогу, іноді додають невелику суму за витрачений час — особливо якщо візити довгі або включають процедури на кшталт біопсії; комерційні випробування ліків платять частіше. У реєстрі це рідко вказано чітко, тому запитайте команду напряму: це абсолютно звичайне питання, і воно не впливає на те, чи вас візьмуть."
        },
        {
        ...
        },
        {
          ...
          "a": "З деяких досліджень — так. Кілька випробувань негормональних підходів спеціально не беруть жінок, які зараз застосовують гормональну терапію, а одне з цього списку просить рік без неї — бо інакше неможливо зрозуміти, від чого ефект: від їхньої добавки чи від ваших пластирів. Науково це зрозуміло, практично — прикро. Чого точно не треба робити, так це відміняти МГТ, щоб підійти під критерії. Поговоріть із лікарем, який її призначив, і шукайте дослідження, під критерії якого ви вже підходите."
        },
        {
          "q": "Чи це безпечно і що, якщо мені дадуть плацебо?",
          "a": "Кожне дослідження тут пройшло етичний комітет — саме це й означає запис у реєстрі з номерами схвалень. Це не означає нульового ризику: випробування ліків несуть побічні ефекти цих ліків і відповідно контролюються, а дослідження добавок і пробіотиків — дуже незначні. Ви цілком можете потрапити в групу плацебо, і в подвійно засліпленому дослідженні до кінця ніхто з учасників процесу не знає, хто в якій групі. Вийти можна будь-коли й без причин, і це не впливає на ваше звичайне лікування — це не ввічливість, а умова, без якої дослідження не дозволили б проводити."
        },
        {
          "q": "Чи потрібне направлення від лікаря?",
          "a": "Майже ніколи. Більшість цих досліджень набирає людей напряму, і ви можете написати команді самі за контактами зі сторінки реєстру. Багато хто потім попросить вашого дозволу повідомити вашого сімейного лікаря — на це варто погодитися, щоб медична картка відповідала тому, що ви насправді приймаєте або носите. Якщо дослідженню потрібні ваші клінічні дані — HbA1c, сканування, призначення — на це попросять окрему згоду."
        }
      ]
    }
  },
