...
export const POSTS = [
  {
    ...
    "ua": {
      ...
      "lead": "Майже всю історію менструальну кров вважали відходами — чимось, що треба вбрати, сховати й викинути. За останні кілька років дослідники почали ставитися до неї навпаки: як до одного з найбагатших і найдоступніших зразків, які дає жіноче тіло. Ось що вона вже робить у медицині — і які автоімунні підказки науковці лише починають зчитувати.",
      "blocks": [
        {
          "t": "p",
          "text": "Скажу чесно, чому це привернуло мою увагу. Я живу з діабетом 1 типу вже 23 роки, тож здала більше зразків крові, ніж можу порахувати — з пальця, з вени, усе на світі. Думка про те, що частина цих аналізів колись могла б робитися зі зразка, який я й так утворюю щомісяця, узагалі без голки, мене справді захоплює. Але у сфері жіночого здоров'я надія й галас стоять поруч, тож я намагалася відокремити те, що справді схвалене й опубліковане, від того, що поки лишається обіцянкою."
        },
        {
          "t": "p",
          "text": "Варто знати, що менструальна кров — це не просто кров. Зібрана в перший день чи близько того, вона несе злущені клітини ендометрія — вистилки матки — разом з імунними клітинами, стовбуровими клітинами і, за одним підрахунком, понад 350 білками, яких немає у звичайній циркулюючій крові. Саме ця суміш і робить її корисною у трьох дуже різних напрямах: як неінвазивний діагностичний зразок, як відновлюване джерело стовбурових клітин і як вікно до імунної системи."
        },
        {
          "t": "h",
        ...
        {
          "t": "p",
          "text": "Найяскравіший приклад із реального життя з'явився в січні 2024 року, коли компанія Qvin отримала схвалення FDA для Q-Pad — першого тесту, дозволеного вимірювати HbA1c із менструальної крові. Він має вигляд звичайної прокладки, але містить невелику смужку для збору; ви носите її, виймаєте смужку й надсилаєте до лабораторії, яка визначає ваш середній цукор за попередні три місяці. Без проколу пальця, без забору крові з вени."
        },
        {
          "t": "p",
        ...
        {
          "t": "p",
          "text": "У дослідженнях на тваринах і ранніх лабораторних роботах MenSC перевіряли проти довгого переліку станів — хвороб печінки, ушкодження серця, інсульту, ран, що не гояться, — і, що особливо близьке мені, діабету 1 типу. В одному дослідженні 2022 року пересадка цих клітин мишам із діабетом покращила їхні симптоми й захистила органи, спрацювавши нарівні з клітинами пуповини, які дослідники вже використовують. Важливо бути чіткою: це робота на мишах, а не схвалене лікування, і шлях від багатонадійного дослідження на гризунах до терапії для людей довгий і всіяний невдачами. Але саме джерело — доступне, відновлюване, без етичних ускладнень — і рухає цю галузь уперед."
        },
        {
          "t": "h",
        ...
        {
          "t": "p",
          "text": "Оскільки це жіноче здоров'я і оскільки мене вже колись обпікали надмірними обіцянками, ось тверезий погляд. Схвалений FDA лише один тест на менструальній крові, і лише для HbA1c; тести на ендометріоз досі в дослідженнях, а не на аптечних полицях. Терапії стовбуровими клітинами переважно доклінічні — клітини в чашках і дослідження на мишах, а не доведене лікування, яке можна попросити. Остерігайтеся будь-якої клініки, що вже продає «лікування менструальними стовбуровими клітинами»; науки для цього поки немає. Що справді реальне — це напрям руху, і він по-справжньому багатообіцяючий."
        },
        {
          "t": "h",
          "text": "Чому викинутий зразок так важить"
        },
        {
          "t": "p",
          "text": "Червона нитка всього цього журналу в тому, що жіноче здоров'я після 40 — та й жіноче здоров'я взагалі — довго було недостатньо вивченим. Почасти причина суто практична: дослідженням потрібні зразки, а зразки зазвичай означають голки, клініки й витрати. Менструальна кров тихо усуває цей бар'єр. Зразок, який більшість із нас усе життя викидала, виявляється щомісячним показанням обміну речовин, гормонів та імунітету — без жодної голки. Якщо здійсниться бодай частина цих досліджень, звичайна менструація може стати одним із найкорисніших діагностичних інструментів, які ми маємо, — і, нарешті, побудованим цілком навколо жіночого тіла."
        },
        {
          "t": "links",
