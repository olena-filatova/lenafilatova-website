...
export const MEAL_PLAN = {
  ...
  ua: {
    ...
    authorLead: 'Чому я пропоную саме цю систему — і чому вона спрацює навіть тоді, коли ви пробували багато разів і нічого не виходило.',
    author: [
      'У мене великий досвід супроводу жінок і родин, які хочуть перейти від хаотичного харчування до збалансованого та здорового. Харчові звички змінювати неймовірно важко — і саме тому потрібна система, а не просто список страв.',
      'Я створила сотні меню для своїх клієнток і точно знаю, які з них приживаються, а які ні. Смаки в людей дуже різні — саме тому тут не обмежений набір страв, а вибір серед багатьох варіантів.',
      'Я також знаю, що змінити своє харчування на ідеальне за один день нереалістично. Тому завжди пропоную компромісні варіанти: вони вже набагато кращі, ніж не міняти нічого.',
    ],
    // Boundaries stated by Lena herself, and stronger for coming from her: the
    // system is not a substitute for clinical advice, it is how that advice
    // stops being a piece of paper.
    authorNote: 'Ця система не медична. Якщо у вас є рекомендації від лікаря чи дієтолога — враховуйте їх. Моя система радше допомагає втілити ці рекомендації в життя і справді змінити харчові звички, а не залишити їх на папері.',
