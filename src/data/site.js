...
export const MEAL_PLAN = {
  ...
  ua: {
    seoTitle: 'Гнучка система харчування на 4 тижні — безкоштовне меню',
    seoDesc: 'Меню на 28 днів, яке справді можна готувати: страви перегукуються, вечеря стає обідом, зайві продукти не псуються. 200 страв на заміну. Безкоштовно.',
    ogImage: '/images/cards/meal-plan-ua.jpg',
    ogImageAlt: 'Гнучка система харчування на 4 тижні — 200 страв і готовий план на 28 днів.',
    kicker: 'Безкоштовне меню',
    ...
    lead: 'Харчуватися стабільно й збалансовано — навіть коли часу обмаль, а стресу вистачає. Це меню знімає щоденне «що сьогодні приготувати» і повертає вам час і сили на важливіші справи.',
    cta: 'Отримати меню',
    ...
    solutionTitle: 'Тут це вирішено інакше',
    solution: [
      {
    ...
    whoTitle: 'Для кого це меню',
    whoLead: 'Передусім — для зайнятих жінок. Особливо для тих, хто живе з інсулінорезистентністю, діабетом або в перименопаузі. Але користуватися ним може будь-хто, кому хочеться нарешті почати харчуватися збалансовано.',
    who: [
      {
    ...
    nlSub: 'Безкоштовно, 24 сторінки. Залиште ім\u2019я та пошту — меню прийде листом одразу після того, як ви підтвердите адресу. Плюс час від часу науково обґрунтовані нотатки про харчування, цукор і перименопаузу. Відписатися можна будь-коли.',
    nlName: 'Ваше ім\u2019я',
    nlBtn: 'Надішліть меню',
    nlSent: 'Майже готово — перевірте пошту та підтвердьте підписку. Одразу після цього надішлю меню.',
    nlDupe: 'Ви вже підписані — перевірте пошту, меню вже в дорозі.',

    faqTitle: 'Коротко',
    faq: [
      {
        q: 'Скільки це коштує?',
        a: 'Нічого. Меню безкоштовне — я прошу лише пошту, щоб було куди його надіслати.',
      },
      {
        q: 'Чи розрахована калорійність?',
        a: 'Ні. Це меню не персоналізоване, і його головна ціль інша — спростити зусилля на готування та привчитися харчуватися регулярно й збалансовано. Калорійність ви можете обрати самостійно під час приготування.',
      },
      {
