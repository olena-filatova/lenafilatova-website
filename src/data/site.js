...
export const HOME = {
  ...
  ua: {
    ...
    heroH1: 'Перименопауза змінила правила вашого цукру.',
    heroH1b: 'Вас ніхто не попередив.',
    heroLead: 'Я живу з цим — діабет 1 типу з 2003 року, зараз перименопауза. Пояснюю, що насправді відбувається там, де гормони й цукор крові стикаються після 40. Доказова інформація, власний досвід і інструменти, щоб упоратися в найважчі часи.',
    heroCta1: 'Спробувати калькулятор', heroCta2: 'Отримати воркбук',
    heroNote: 'Я заснувала Школу діабету та стала співзасновницею продуктів для здоров’я й велнесу на основі AI. Живу з діабетом 1 типу 23 роки.',
