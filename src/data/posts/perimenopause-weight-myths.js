export default {
  ...
  "en": {
    ...
    "excerpt": "Your weight can stay the same while fat moves to your middle. Five myths I believed, and what actually helped: strength training, protein, sleep, less stress.",
  ...
  "ua": {
    ...
    "excerpt": "Вага може не змінюватися, а жир — переміщатися на живіт. П’ять міфів про вагу в перименопаузі, у які я вірила, і що справді допомогло: силові, білок, сон і менше стресу.",
