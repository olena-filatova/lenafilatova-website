export default {
  ...
  "en": {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "The strongest signal comes from population data. A Finnish population-based study of 324 women aged 63 found that women carrying markers of insulin resistance had a significantly increased risk of female androgenetic alopecia. The markers that separated the women with extensive hair loss from those with normal or minimal thinning were waist and neck circumference, abdominal obesity, mean insulin concentration and urinary albumin-to-creatinine ratio. Raised fasting insulin, above 10 mU/l, went with higher odds of extensive hair loss, and that held after adjustment; the higher risk in the top fifth for neck or waist circumference did not. A father with hair loss was also more common in the group with alopecia — heredity has not gone anywhere."
      },
      {
        "t": "p",
        "text": "Then look at what happens when a small study measures insulin directly. A 2024 case-control study compared 31 premenopausal women with female-pattern hair loss against 31 without. Waist circumference and BMI were clearly higher in the hair-loss group — 81.9 cm against 72.6 cm, and BMI 26.3 against 24.5. The authors report no significant difference in HOMA-IR, fasting insulin, fasting glucose, triglycerides or HDL — although their own results give fasting insulin as 9.9 against 6.9 mIU/L with p=0.029, and HOMA-IR as 2.4 against 1.6 (p=0.073), so the insulin numbers leaned the same way. Sixty-two women is a small study and it cannot settle anything. It is still a useful corrective: even in a study built to look for it, the insulin signal came out weaker and less tidy than the headlines suggest."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "If you have Type 1, the order of suspicion changes, and this is the part I most wish someone had told me earlier. Type 1 is autoimmune, and it travels in company: thyroid antibodies are found in roughly a fifth of people with Type 1, biopsy-confirmed coeliac disease in around 6% (nearer 3% in adults), and alopecia areata clusters with autoimmune thyroid disease. Untreated thyroid disease thins hair. So does the iron deficiency that undiagnosed coeliac produces. Both are far likelier explanations in a woman with Type 1 than insulin resistance is — so thyroid and ferritin first, metabolic theories after."
      },
      {
        "t": "h",
        ...
        "items": [
          {
            ...
            "detail": "A population-based study of 324 Finnish women aged 63 comparing those with extensive hair loss against those with normal or minimal loss. Waist and neck circumference, abdominal obesity, mean insulin concentration and the urinary albumin-to-creatinine ratio were all significantly higher in the extensive-hair-loss group, and women in the highest quintiles of neck or waist circumference had a significantly increased risk in the unadjusted analysis (odds ratios 2.25 and 1.75) that did not remain significant after adjustment; the raised odds with hyperinsulinaemia (fasting insulin above 10 mU/l), microalbuminuria and paternal history of alopecia did. Paternal history of alopecia was more common in the group with female androgenetic alopecia. It is observational and cross-sectional, so it establishes association rather than cause, and the markers used are proxies for insulin resistance rather than direct measures of it.",
            "cite": "Matilainen V et al. · J Cardiovasc Risk 2003;10(3):227–231",
            "url": "https://journals.sagepub.com/doi/10.1097/01.hjr.0000070200.72977.c6"
          },
          {
            "claim": "When insulin was measured directly in a small case-control study, body shape separated the groups clearly and the insulin numbers much less clearly.",
            "detail": "A hospital-based case-control study of 31 premenopausal women with female-pattern hair loss and 31 controls, mean ages 29.8 and 28.9. Waist circumference (81.9 ± 11.75 cm vs 72.58 ± 8.86 cm, p=0.001) and BMI (26.28 ± 4.09 vs 24.46 ± 2.78 kg/m², p=0.013) were significantly higher in the cases. The authors report no significant differences in HOMA-IR, fasting insulin, fasting blood glucose, triglycerides or HDL, although their results text gives fasting insulin as 9.92 vs 6.94 mIU/L with p=0.029 and HOMA-IR as 2.39 vs 1.61 (p=0.073) — an inconsistency the paper does not explain. The authors conclude that female-pattern hair loss warrants early screening for metabolic syndrome, and list the small sample, the single diagnostic scale and the absence of a full hormonal evaluation as limitations.",
            "cite": "Reddy A et al. · Case-control study of metabolic syndrome in premenopausal women with female pattern hair loss · Cureus 2024",
          ...
          },
          {
            ...
            "detail": "A review of female-pattern hair loss describing miniaturisation — the progressive conversion of terminal follicles to vellus-like follicles, with shortened anagen and an extended empty (kenogen) phase — and stating that the role of androgens is not yet clear, since the condition occurs in some women with normal circulating androgens. It describes tests that separate it from telogen effluvium, advises evaluating thyroid function, notes the European Consensus recommendation of free androgen index and prolactin as screening tests with a two-month pause from hormonal contraceptives, and describes topical minoxidil 2% twice daily or 5% foam once daily as first-line, requiring at least 12 months before efficacy is judged. Finasteride 1 mg a day for 12 months was ineffective in postmenopausal women.",
    ...
    "faq": [
      {
        ...
        "a": "It is associated with it, and there is a plausible mechanism, but no trial has shown that insulin resistance causes hair thinning or that treating it regrows hair. Population data links markers of insulin resistance — waist and neck circumference, abdominal obesity, mean insulin — with an increased risk of female-pattern hair loss. A smaller case-control study that measured insulin directly found a clear difference only in waist circumference and BMI; the authors report no significant difference in HOMA-IR or fasting insulin, though insulin ran higher in the women with hair loss. Treat it as one contributing factor among several, alongside falling oestrogen and heredity, rather than the explanation."
      },
      {
      ...
      },
      {
        ...
        "a": "Thyroid function and ferritin, before anything metabolic. Type 1 is autoimmune and clusters with other autoimmune conditions: thyroid antibodies are present in roughly a fifth of people with Type 1, and biopsy-confirmed coeliac disease in around 6%, fewer in adults. Untreated thyroid disease thins hair, and undiagnosed coeliac disease causes the iron deficiency that does the same. Both are more likely explanations than insulin resistance, and both are straightforward to test for. Ask about coeliac screening at the same time."
      },
      {
  ...
  "ua": {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "Найсильніший сигнал дають популяційні дані. Фінське популяційне дослідження 324 жінок віком 63 роки виявило, що жінки з маркерами інсулінорезистентності мали значно вищий ризик андрогенетичної алопеції. Маркери, які відрізняли жінок зі значним випадінням від тих, у кого волосся було нормальним або майже не рідшало, — обхват талії та шиї, абдомінальне ожиріння, середня концентрація інсуліну й співвідношення альбуміну до креатиніну в сечі. Підвищений інсулін натще, понад 10 мОд/л, пов'язувався з вищими шансами значного випадіння, і це збереглося після поправки на інші чинники; вищий ризик у верхній п'ятій частині за обхватом шиї чи талії — ні. Батько з випадінням волосся також траплявся частіше в групі з алопецією — спадковість нікуди не поділася."
      },
      {
        "t": "p",
        "text": "Тепер подивіться, що відбувається, коли невелике дослідження вимірює інсулін напряму. Дослідження 2024 року порівняло 31 жінку в пременопаузі з андрогенетичним випадінням і 31 без нього. Обхват талії та ІМТ були виразно вищими в групі з випадінням — 81,9 см проти 72,6 см та ІМТ 26,3 проти 24,5. Автори пишуть, що HOMA-IR, інсулін натще, глюкоза натще, тригліцериди й ЛПВЩ значущо не відрізнялися, — хоча в їхніх же результатах інсулін натще становить 9,9 проти 6,9 мОд/л при p=0,029, а HOMA-IR 2,4 проти 1,6 (p=0,073), тож показники інсуліну схилялися в той самий бік. Шістдесят дві жінки — це мало, і це нічого не вирішує. Проте це корисне уточнення: навіть у дослідженні, яке саме цього шукало, інсуліновий сигнал вийшов слабшим і менш чітким, ніж обіцяють заголовки."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "Тут є два окремі важелі, і корисно розуміти, за який ви тягнете. Лікувати саме волосся: топічний міноксидил — єдиний засіб першої лінії з вагомими доказами, 2% двічі на день або 5% піна раз на день, і потрібно щонайменше дванадцять місяців, перш ніж судити про результат. Пероральні варіанти з оглядів (спіронолактон, фінастерид, дутастерид) — це рецептурні рішення зі суттєвими застереженнями, зокрема з тим, що фінастерид по 1 мг на день не допоміг жінкам у постменопаузі в річному дослідженні. Є ще [новий міноксидил пролонгованої дії в таблетках](/ua/blog/extended-release-minoxidil-female-hair-loss/), який показав справжній приріст — у відкритому дослідженні без контрольної групи, і саме стільки ваги це й заслуговує."
      },
      {
        "t": "p",
        ...
        "items": [
          {
            ...
            "detail": "Популяційне дослідження 324 фінських жінок віком 63 роки, яке порівнювало жінок зі значним випадінням волосся з тими, у кого волосся було нормальним або майже не рідшало. Обхват талії та шиї, абдомінальне ожиріння, середня концентрація інсуліну й співвідношення альбуміну до креатиніну в сечі були значно вищими в групі зі значним випадінням, а жінки у верхніх квінтилях за обхватом шиї чи талії мали значно вищий ризик у нескоригованому аналізі (відношення шансів 2,25 і 1,75), який не зберіг значущості після поправки; підвищені шанси при гіперінсулінемії (інсулін натще понад 10 мОд/л), мікроальбумінурії та батьківському анамнезі алопеції — зберегли. Батьківський анамнез алопеції траплявся частіше в групі з андрогенетичною алопецією. Дослідження обсерваційне й одномоментне, тож встановлює зв'язок, а не причину, і використані маркери є непрямими показниками інсулінорезистентності, а не прямими вимірами.",
            "cite": "Matilainen V et al. · J Cardiovasc Risk 2003;10(3):227–231",
            "url": "https://journals.sagepub.com/doi/10.1097/01.hjr.0000070200.72977.c6"
          },
          {
            "claim": "Коли інсулін виміряли напряму в невеликому дослідженні, групи чітко розділила форма тіла, а показники інсуліну — значно менш чітко.",
            "detail": "Госпітальне дослідження типу «випадок-контроль» за участю 31 жінки в пременопаузі з андрогенетичним випадінням волосся та 31 контрольної учасниці, середній вік 29,8 і 28,9 року. Обхват талії (81,9 ± 11,75 см проти 72,58 ± 8,86 см, p=0,001) та ІМТ (26,28 ± 4,09 проти 24,46 ± 2,78 кг/м², p=0,013) були значно вищими у групі випадків. Автори повідомляють, що HOMA-IR, інсулін натще, глюкоза натще, тригліцериди та ЛПВЩ значущо не відрізнялися, хоча в тексті результатів інсулін натще становить 9,92 проти 6,94 мОд/л при p=0,029, а HOMA-IR — 2,39 проти 1,61 (p=0,073); цієї розбіжності стаття не пояснює. Автори роблять висновок, що андрогенетичне випадіння у жінок є підставою для раннього скринінгу метаболічного синдрому, і серед обмежень називають малу вибірку, єдину діагностичну шкалу та відсутність повної гормональної оцінки.",
            "cite": "Reddy A et al. · Дослідження метаболічного синдрому в жінок у пременопаузі з андрогенетичним випадінням волосся · Cureus 2024",
            "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC11433530/"
          },
          {
            "claim": "Підвищений інсулін напряму знижує ГЗСГ, залишаючи в обігу більше вільного тестостерону.",
            "detail": "У шести жінок з ожирінням і синдромом полікістозних яєчників, у яких гормони яєчників уже були пригнічені, зниження інсуліну діазоксидом протягом десяти днів підвищило ГЗСГ на 32%, тоді як рівні статевих стероїдів не змінилися. Автори дійшли висновку, що гіперінсулінемія знижує рівень глобуліну, що зв'язує статеві гормони, незалежно від будь-якого впливу на циркулюючі статеві стероїди — тобто інсулін пригнічує вироблення ГЗСГ у печінці, а не діє через самі гормони. Оскільки ГЗСГ зв'язує тестостерон, нижчий його рівень залишає більшу частку тестостерону біологічно доступною. Саме цей механізм найчастіше наводять як ланку між інсулінорезистентністю та андрогензалежним випадінням волосся, але продемонстровано його в популяціях із СПКЯ, а не в дослідженнях із результатами щодо волосся.",
            "cite": "Nestler JE et al. · J Clin Endocrinol Metab 1991;72(1):83–89",
            "url": "https://pubmed.ncbi.nlm.nih.gov/1898744/"
          },
          {
            "claim": "Роль андрогенів у андрогенетичному випадінні у жінок не з'ясована, і перед діагнозом треба виключити інші причини.",
            "detail": "Огляд андрогенетичного випадіння волосся у жінок, який описує мініатюризацію — поступове перетворення термінальних фолікулів на пушкові зі вкороченим анагеном і подовженою порожньою фазою (кеногеном) — і зазначає, що роль андрогенів досі не з'ясована, оскільки стан трапляється в частини жінок із нормальним рівнем циркулюючих андрогенів. Огляд описує тести, що відрізняють його від телогенової алопеції, радить оцінити функцію щитоподібної залози, наводить рекомендацію Європейського консенсусу щодо індексу вільних андрогенів і пролактину як скринінгу з перервою в два місяці після гормональних контрацептивів і описує топічний міноксидил 2% двічі на день або 5% піну раз на день як першу лінію, для оцінки якої потрібно щонайменше 12 місяців. Фінастерид по 1 мг на день протягом 12 місяців був неефективним у жінок у постменопаузі.",
            "cite": "Bhat YJ et al., Female Pattern Hair Loss — An Update · Indian Dermatol Online J 2020;11(4)",
            "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC7413422/"
          },
          {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Щитоподібну залозу й феритин, перш ніж усе метаболічне. Діабет 1 типу аутоімунний і групується з іншими аутоімунними станами: антитіла до щитоподібної залози є приблизно в п'ятої частини людей з ним, а целіакія, підтверджена біопсією, — приблизно в 6%, у дорослих рідше. Нелікована патологія щитоподібної залози розріджує волосся, а недіагностована целіакія спричиняє дефіцит заліза, який робить те саме. Обидві причини ймовірніші за інсулінорезистентність, і обидві легко перевірити. Заразом попросіть і скринінг на целіакію."
      },
      {
