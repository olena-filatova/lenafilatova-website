...
export default {
  ...
  "ua": {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "Щоб побачити ширшу картину того, куди рухається наука про діабет, вам може бути корисною й моя нотатка про те, [що каже нове дослідження про діабет 2 типу](/ua/blog/type-2-diabetes-research/)."
      },
      {
        "t": "p",
