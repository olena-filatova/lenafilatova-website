export default {
  ...
  "en": {
    ...
    "meta": "26 August 2026 · 12 min read",
  ...
  "ua": {
    ...
    "meta": "26 серпня 2026 · 12 хв читання",
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "Перше припущення — те, що тихо відступило. Візьмімо Novo Nordisk, найбільшого виробника інсуліну у світі. У 2025 році весь інсулін компанії — тривалої дії, швидкої дії, змішаний і людський — дав 53,1 млрд данських крон із 309,1 млрд крон загальних продажів. Це 17% компанії, і за рік показник зменшився на 1%. Один лише Ozempic приніс більш ніж удвічі більше. Один лише Wegovy приніс більше, ніж увесь інсулін Novo разом узятий, а напрям лікування ожиріння зріс на 31% — до 82,3 млрд крон. У Eli Lilly тирзепатид, який продають як Mounjaro та Zepbound, приніс 36,5 млрд доларів у 2025-му: близько 56% усього доходу компанії. Інсулін — це старий бізнес, і про це кажуть їхні власні цифри."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "І це не поодинокий випадок. Lilly з 2018 року працює з Sigilon над інкапсульованими клітинами, що виробляють інсулін, а в 2023-му купила компанію повністю. Novo Nordisk із 2023 року фінансує роботу канадської біопринтингової компанії Aspect Biosystems саме над цим завданням. А Vertex у 2022 році заплатила близько 320 мільйонів доларів за ViaCyte — купивши і програму острівцевих клітин зі стовбурових, і, чесно кажучи, свого найближчого конкурента."
      },
      {
        "t": "h",
      ...
      {
        "t": "p",
        "text": "Ось частина, яка, на мою думку, все вирішує. Найдалі просунута спроба функціонального одужання — це зиміслецел від Vertex: вирощені в лабораторії острівцеві клітини, які вводять у кровоносне русло печінки. У перших дванадцяти пацієнтів, за якими спостерігали рік, у всіх відновилося власне вироблення інсуліну, у всіх припинилися важкі гіпоглікемії й були досягнуті рекомендовані показники глюкози, а десятеро з дванадцятьох повністю відмовилися від інсуліну. Це опубліковано в New England Journal of Medicine у червні 2025 року, і препарат має прискорені регуляторні статуси у США, ЄС, Великій Британії та Саудівській Аравії."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "Vertex не продає інсулін. Як і Sana Biotechnology, як і CRISPR Therapeutics, як і Aspect. Канібалізація не може стримувати компанію, якій нічого канібалізувати, — і в неї є всі комерційні підстави забрати ринок у тих, хто його продає. Ось куди насправді вказує стимул. Якщо хочете деталей про те, хто що веде, у мене є [трекер досліджень щодо лікування діабету 1 типу](/blog/type-1-diabetes-cure-trials/) і окрема нотатка про [донорські трансплантації острівцевих клітин, які вже повернули незалежність від інсуліну](/blog/islet-transplant-insulin-independence/) невеликій кількості людей."
      },
      {
        "t": "h",
      ...
      },
      {
        ...
        "rows": [
          [
            "Вони приховують ліки від діабету",
          ...
          [
            ...
            "Радше байдужість, ніж змова, — але затримка від цього така сама реальна"
          ],
          [
      ...
      {
        "t": "p",
        "text": "Далі — виробництво. Вирощувати живі клітини стабільної якості для мільйонів людей — зовсім інше промислове завдання, ніж наповнювати флакони. Саме тому технологія Novo пішла до спеціалістів із біопринтингу, і саме тому Vertex купила у ViaCyte разом із наукою ще й виробництво."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "По-перше, не дозволяйте цій історії зашкодити вашому власному лікуванню. Я бачила, як переконання «тут усе підлаштовано» перетворюється на пропущені прийоми, відмову від технологій і тихий вихід із системи, яка — попри всі свої вади — і є тим місцем, звідки беруться ваш інсулін, ваш моніторинг і ваш лікар. Цинізм щодо індустрії — розумна річ. Дозволити йому дійти до того, як ви керуєте своїм діабетом, — дорого, і платите за це ви."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "І по-четверте, якщо хочете спрямувати свій гнів туди, де він зсуває цифри: фінансування досліджень і ціноутворення на ліки. Не на те, чи приховують ліки від діабету, — докази кажуть, що ні, — а на те, чи будуть ті ліки, які вже на підході, коштувати стільки, щоб ви справді могли їх отримати. Це живе питання, воно не вирішене, і, на відміну від змови, у ньому тиск уже доводив свою дієвість."
      },
      {
        "t": "h",
    ...
    "faq": [
      {
        "q": "Чи заробляють фармкомпанії на інсуліні більше, ніж заробили б на ліках, які виліковують діабет?",
