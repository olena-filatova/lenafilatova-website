...
export default {
  "slug": "fermented-foods-gut-microbiome-review",
  "date": "2026-08-18",
  "image": "/images/fermented-foods-gut-microbiome-review.jpg",
  "cats": [
    "nutrition"
  ],
  "en": {
    ...
    "blocks": [
      {
        "t": "p",
        "text": "The review’s useful move is to separate what a fermented food delivers into three things, because they behave differently. There are the live microbes themselves — probiotics. There are prebiotic substrates: material your resident bacteria can feed on. And there are postbiotic metabolites — compounds the fermentation has already produced before the food reaches you, which need no live organism to survive the journey. A jar of sauerkraut is all three at once, which is part of why studying it is so awkward."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "The second idea I had not seen framed this way is the oral–gut axis. The review describes fermented foods acting on it through both transient microbial exposure and metabolite-mediated signalling — meaning the mouth is the first microbial community the food meets, not merely a corridor it passes through on the way somewhere important. Further down, microbial metabolites, short-chain fatty acids in particular, help regulate colonic regulatory T cell homeostasis: the immune cells whose job is to stop the gut from overreacting to its own contents. That is the mechanistic bridge between what you eat and how inflamed your gut lining is."
      },
      {
        "t": "p",
        "text": "So what has been shown in humans? The review cites work in which fermented-food consumption increased microbiota diversity and reduced levels of inflammatory markers — a real result, and consistent with the six-week [kefir-plus-fibre trial](/blog/kefir-fibre-synbiotic-inflammation/) I wrote about earlier this month. But the authors are candid about the ceiling on all of it: mechanisms remain, in their words, insufficiently defined in humans, because of strain variability, inconsistency in microbial composition across fermented foods, heterogeneous clinical outcomes and regulatory ambiguity. Two jars of kimchi are not the same intervention. That is not a rhetorical hedge — it is the reason the trials disagree."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "The wider evidence is thinner than the enthusiasm, and someone has now measured how much thinner. A scoping review in Frontiers in Endocrinology in January went through 23 systematic reviews and meta-analyses on targeting the gut microbiome in type 2 diabetes, covering 142 original studies. Most reported metabolic improvements. But only one of the 23 was rated high quality and 16 were rated very low, and just 8.7% reported adverse events at all. Their conclusion is that regulating the microbiome may be beneficial while the evidence is limited by study quality — which is a good deal weaker than the way this literature tends to get summarised."
      },
      {
        "t": "p",
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "detail": "The review applied PRISMA-ScR methods to 23 systematic reviews and meta-analyses published between 2015 and 2024, consolidating 142 distinct original studies. Probiotics or synbiotics were the intervention in 63.3% of cases, and 95.65% of the included reviews measured fasting blood glucose and HbA1c. Most reported improvements in metabolic markers — but only one of the 23 was rated high quality, while 16 were rated very low. Only 8.7% reported adverse events. The authors concluded that regulating the gut microbiome may be beneficial but that the evidence is limited by study quality, and called for larger trials with longer follow-up and standardised adverse-event reporting.",
            "cite": "Frontiers in Endocrinology · Scoping review, 29 January 2026",
        ...
        "items": [
          {
            ...
            "desc": "The human-trial version of this question, with inflammatory blood markers as the outcome."
          },
          {
            "name": "Gut bacteria, fibre and hormones: what 2026’s precision-nutrition research means for women over 40",
            "url": "/blog/gut-microbiome-precision-nutrition-women-2026/",
            "desc": "The wider picture on feeding your microbiome, and why the ‘best’ diet may be a personal one."
          }
        ]
      }
    ],
    "faq": [
      {
        "q": "Should I eat fermented food to control my blood sugar?",
        "a": "Not as a glucose strategy on its own. The best recent data — 303 adults on 200 g of fermented yoghurt a day for 12 weeks — found average glucose about 0.23 mmol/L lower, in a study with no control group, run by the yoghurt’s manufacturer. That is a small effect from a weak design. Eat fermented food because it is a decent food that feeds your gut bacteria, and keep the things with strong glucose evidence behind them — fibre, meal composition, movement after eating — as the actual levers. If you are managing diabetes, remember that 200 g of yoghurt is also carbohydrate, so count it as you normally would."
      },
      {
  ...
  "ua": {
    ...
    "blocks": [
      {
        "t": "p",
        "text": "Корисний хід цього огляду — розділити те, що дає ферментований продукт, на три речі, бо вони поводяться по-різному. Є самі живі мікроби — пробіотики. Є пребіотичні субстрати: матеріал, яким можуть живитися ваші власні бактерії. І є постбіотичні метаболіти — сполуки, які ферментація вже виробила до того, як їжа дійшла до вас, і яким не потрібен живий організм, щоб пережити дорогу. Банка сауеркрауту — це все три одночасно, і саме тому досліджувати її так незручно."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "Друга ідея, якої я раніше в такому формулюванні не бачила, — вісь «ротова порожнина — кишківник». В огляді описано, як ферментована їжа діє на неї і через тимчасову мікробну експозицію, і через сигнали метаболітів: тобто ротова порожнина — це перша мікробна спільнота, з якою зустрічається їжа, а не просто коридор на шляху кудись важливіше. Далі мікробні метаболіти, насамперед коротколанцюгові жирні кислоти, допомагають регулювати гомеостаз регуляторних T-клітин у товстій кишці — імунних клітин, чия робота полягає в тому, щоб кишківник не реагував надміру на власний вміст. Це і є механістичний мостик між тим, що ви їсте, і тим, наскільки запалена ваша кишкова стінка."
      },
      {
        "t": "p",
        "text": "То що показано на людях? Огляд покликається на роботи, у яких споживання ферментованої їжі підвищувало різноманіття мікробіоти й знижувало рівні маркерів запалення — це реальний результат, і він узгоджується з шеститижневим [дослідженням кефіру з клітковиною](/ua/blog/kefir-fibre-synbiotic-inflammation/), про яке я писала цього місяця. Але автори відкрито говорять про межу всього цього: механізми, за їхніми словами, описані в людини недостатньо — через варіабельність штамів, непослідовність мікробного складу різних ферментованих продуктів, різнорідні клінічні результати й нормативну неоднозначність. Дві банки кімчі — це не одне й те саме втручання. І це не риторичне застереження, а причина, чому дослідження суперечать одне одному."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "Ширша доказова база слабша за захоплення, і хтось нарешті виміряв, наскільки. Оглядове дослідження у Frontiers in Endocrinology у січні опрацювало 23 систематичні огляди й метааналізи про вплив на мікробіом при діабеті 2 типу, що охоплюють 142 первинних дослідження. Більшість повідомляла про покращення метаболічних показників. Але лише один із 23 отримав високу оцінку якості, а 16 оцінено як дуже низькоякісні, і лише 8,7% узагалі повідомляли про побічні явища. Їхній висновок: регулювання мікробіому може бути корисним, але доказова база обмежена якістю досліджень — а це значно слабше за те, як цю літературу зазвичай підсумовують."
      },
      {
        "t": "p",
      ...
      },
      {
        ...
        "items": [
          ...
          },
          {
            ...
            "detail": "Огляд за методологією PRISMA-ScR охопив 23 систематичні огляди й метааналізи, опубліковані у 2015–2024 роках, які разом узагальнюють 142 окремих первинних дослідження. У 63,3% випадків втручанням були пробіотики або синбіотики, а 95,65% включених оглядів вимірювали глюкозу натще і HbA1c. Більшість повідомляла про покращення метаболічних показників — але лише один із 23 оглядів отримав високу оцінку якості, тоді як 16 оцінено як дуже низькоякісні. Лише 8,7% повідомляли про побічні явища. Автори підсумували, що вплив на мікробіом може бути корисним, але доказова база обмежена якістю досліджень, і закликали до більших досліджень із довшим спостереженням і стандартизованим звітуванням про побічні явища.",
            "cite": "Frontiers in Endocrinology · Оглядове дослідження, 29 січня 2026",
            "url": "https://www.frontiersin.org/journals/endocrinology/articles/10.3389/fendo.2026.1682174/full"
          },
          {
        ...
        "items": [
          {
            ...
            "desc": "Версія цього ж питання з дослідженням на людях, де результатом були маркери запалення в крові."
          },
          {
            "name": "Кишкові бактерії, клітковина і гормони: що дослідження точного харчування 2026 року означають для жінок після 40",
            "url": "/ua/blog/gut-microbiome-precision-nutrition-women-2026/",
            "desc": "Ширша картина того, як живити мікробіом, і чому «найкраща» дієта може бути персональною."
          }
        ]
      }
    ],
    "faq": [
      {
        "q": "Чи варто їсти ферментовану їжу, щоб контролювати цукор крові?",
        "a": "Не як окрему стратегію для глюкози. Найкращі свіжі дані — 303 дорослих, які 12 тижнів їли 200 г ферментованого йогурту щодня, — показали середню глюкозу приблизно на 0,23 ммоль/л нижчою, і це дослідження без контрольної групи, проведене виробником йогурту. Малий ефект зі слабкого дизайну. Їжте ферментовані продукти тому, що це нормальна їжа, яка живить ваші кишкові бактерії, а справжніми важелями залишайте те, за чим стоять переконливі дані щодо глюкози: клітковину, склад страви, рух після їжі. Якщо ви керуєте діабетом, пам’ятайте, що 200 г йогурту — це ще й вуглеводи, тож рахуйте їх як завжди."
      },
      {
