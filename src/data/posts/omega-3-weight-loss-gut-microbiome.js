...
export default {
  ...
  "en": {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "The link to risk is made through correlation. Across all 34 women, several species — including P. vulgatus and A. putredinis, which rose in some of the omega-3 subgroups rather than in the main omega-3 versus placebo comparison — tracked with better readings on markers that matter in postmenopausal breast cancer: bioavailable oestradiol, the adiponectin-to-leptin ratio and C-reactive protein. There is a plausible mechanism behind the oestrogen half of it — gut bacteria carrying the enzyme beta-glucuronidase can reactivate oestrogen metabolites in the intestine and send them back into circulation, which is the [estrobolome story](/blog/estrobolome-gut-oestrogen-menopause/) (though in this study the share of bacteria carrying that enzyme did not change over the six months), and after menopause that route matters more because the ovaries have stopped competing. P. vulgatus, one of the bacteria that rose, correlated negatively with plasma oestradiol."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "The short-chain fatty acid results are similarly partial. Women on omega-3 showed a significantly greater percentage increase in plasma propionate; for butyrate the paper contradicts itself — its results report a significantly smaller percentage change on omega-3 than on placebo, while its discussion says plasma butyrate did not change significantly. Acetate rose more in the women who lost over 10%. Propionate and butyrate are both made by gut bacteria fermenting fibre, and both are generally treated as useful, so a supplement that appears to push one up while holding the other back, or at best leaving it flat, is not a clean win — it is a differently shaped gut. For contrast, the six-week trial in which [kefir plus a diverse fibre mix outperformed omega-3 on inflammatory markers](/blog/kefir-fibre-synbiotic-inflammation/) found butyrate rising, and tied that rise to the fall in IL-6."
      },
      {
        "t": "p",
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "claim": "The enriched bacteria correlated with breast-cancer risk markers; plasma propionate rose; the butyrate result is reported inconsistently.",
            "detail": "In the same analysis, across all 34 women at 6 months, proportional abundance of short-chain-fatty-acid-producing species including Phocaeicola vulgatus and Alistipes putredinis (raised in omega-3 subgroups, not among the five species enriched in the main omega-3 versus placebo comparison) correlated with bioavailable oestradiol, the adiponectin:leptin ratio and C-reactive protein. Women receiving omega-3 showed a significantly greater percentage change in plasma propionate; the results (Fig. 4G) report a significantly reduced percentage change in butyrate on omega-3 versus placebo, but the discussion states that no significant changes in plasma butyrate were observed, while acetate rose significantly in women losing >10% of body weight. These are correlations within a pilot cohort, not demonstrations of cause; the authors call for further studies to establish causal relationships between weight loss, omega-3, the microbiome and breast-cancer risk.",
            "cite": "Cook KL et al. · Cancer Prev Res 2026;19(8):473–488",
            "url": "https://doi.org/10.1158/1940-6207.CAPR-26-0021"
          },
          {
  ...
  "ua": {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "Зв’язок із ризиком проводиться через кореляції. У всіх 34 жінок кілька видів — зокрема P. vulgatus та A. putredinis, яких стало більше в окремих підгрупах омега-3, а не в основному порівнянні омега-3 з плацебо, — йшли поруч із кращими показниками маркерів, що мають значення для раку грудей у постменопаузі: біодоступного естрадіолу, співвідношення адипонектину до лептину та C-реактивного білка. За естрогеновою половиною цієї історії стоїть правдоподібний механізм: кишкові бактерії з ферментом бета-глюкуронідазою можуть повертати метаболіти естрогену в активну форму просто в кишківнику й відправляти їх назад у кров — це [історія естроболому](/ua/blog/estrobolome-gut-oestrogen-menopause/) (хоча в цьому дослідженні частка бактерій із цим ферментом за півроку не змінилася), і після менопаузи цей шлях важить більше, бо яєчники вже не конкурують. P. vulgatus, одна з бактерій, кількість якої зросла, негативно корелювала з рівнем естрадіолу в плазмі."
      },
      {
        "t": "p",
      ...
      {
        "t": "p",
        "text": "З короткими жирними кислотами так само неповно. У жінок на омега-3 відсоткове зростання пропіонату в плазмі було значуще більшим; щодо бутирату стаття суперечить сама собі: у результатах відсоткова зміна на омега-3 значуще менша, ніж на плацебо, а в обговоренні сказано, що бутират у плазмі значуще не змінився. Ацетат більше зріс у жінок, які втратили понад 10% ваги. І пропіонат, і бутират утворюються, коли кишкові бактерії ферментують клітковину, і обидва зазвичай вважають корисними, тож добавка, яка начебто піднімає один і стримує інший або в кращому разі залишає його на місці, — це не чиста перемога, а кишківник іншої форми. Для контрасту: у шеститижневому дослідженні, де [кефір із різноманітною клітковиною перевершив омега-3 за маркерами запалення](/ua/blog/kefir-fibre-synbiotic-inflammation/), бутират саме зростав, і це зростання пов’язали зі зниженням IL-6."
      },
      {
        "t": "p",
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "claim": "Численніші бактерії корелювали з маркерами ризику раку грудей; пропіонат у плазмі зріс; результат щодо бутирату подано суперечливо.",
            "detail": "У тому ж аналізі в усіх 34 жінок через 6 місяців частка видів, що продукують короткі жирні кислоти, зокрема Phocaeicola vulgatus та Alistipes putredinis (яких стало більше в підгрупах омега-3, але не серед п’яти видів основного порівняння омега-3 з плацебо), корелювала з біодоступним естрадіолом, співвідношенням адипонектин:лептин і C-реактивним білком. У жінок, які отримували омега-3, відсоткова зміна пропіонату в плазмі була значуще більшою; у результатах (рис. 4G) відсоткова зміна бутирату на омега-3 значуще менша, ніж на плацебо, але в обговоренні сказано, що значущих змін бутирату в плазмі не спостерігали, тоді як ацетат значуще зріс у жінок, які втратили понад 10% ваги. Це кореляції в межах пілотної когорти, а не доказ причинності; автори закликають до подальших досліджень, які встановили б причинні зв’язки між схудненням, омега-3, мікробіомом і ризиком раку грудей.",
            "cite": "Cook KL et al. · Cancer Prev Res 2026;19(8):473–488",
            "url": "https://doi.org/10.1158/1940-6207.CAPR-26-0021"
          },
          {
