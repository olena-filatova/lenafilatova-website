  ...
  "ua": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Залежить від вашого зросту, бо ІМТ — це вага, поділена на зріст у метрах у квадраті. Помножте 0,1 на квадрат свого зросту — і матимете відповідь: при 1,60 м це приблизно 260 г на рік, при 1,65 м — близько 270 г, при 1,70 м — близько 290 г. Група високого приросту в дослідженні — 0,6 кг/м² на рік і більше — це приблизно 1,6 кг на рік для жінки зростом 1,65 м, тобто, якщо так триватиме сім років, — близько 11 кг. Ось порядок величини, який варто помічати. Але порахуйте на власний зріст, а не беріть мій, і сприймайте це як спосіб уявити результат, а не як мету: дослідження виміряло, що сталося з популяцією, і ніхто не перевіряв, чи змінить ваш власний результат те, що ви втримаєте свій нахил рівним."
      }
    ]
  }
};
