export default {
  ...
  "en": {
    ...
    "metaDesc": "2026 Lancet cohort: postmenopausal women on tirzepatide plus hormone therapy lost 35% more weight than on tirzepatide alone. And the bone-and-muscle caveat.",
  ...
  "ua": {
    ...
    "metaDesc": "The Lancet, 2026: у постменопаузі тирзепатид із гормональною терапією дав на 35% більшу втрату ваги, ніж сам тирзепатид. І застереження щодо кісток і м’язів.",
