export default {
  ...
  "ua": {
    ...
    "metaDesc": "Огляд Nutrients 2026 про естроболом — кишкові бактерії, що повертають естроген у кровообіг: що змінюється після менопаузи і які зміни в харчуванні мають докази.",
