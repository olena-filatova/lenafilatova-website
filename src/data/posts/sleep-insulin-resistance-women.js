export default {
  ...
  "ua": {
    ...
    "metaDesc": "Рандомізоване дослідження шість тижнів забирало в жінок 90 хвилин сну щоночі. Інсулінорезистентність зросла приблизно на 15% — а після менопаузи більше.",
